...
class TrackingService : LifecycleService() {
    ...
    // Updates the current action of notification
    private fun updateNotificationTrackingState(isTracking: Boolean) {
        ...
        // Remove all actions that are in notifications
        ...
        if (!serviceKilled) {
            ...
            // Update and show the notificationManager with the new notification
    ...
    // Starts a foreground service on phone
    private fun startForegroundService() {
        ...
        // check for above android OREO and above
        ...
        timeRunInSeconds.observe(this, Observer {
            if (!serviceKilled) {
                // Create new notification
                // Update time in seconds in notification
